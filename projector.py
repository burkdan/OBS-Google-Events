...
def script_update(settings):
    ...
    # settings2 = obs.obs_data_create()
    # obs.obs_data_set_string(settings2, "file", "C:/Users/Daniel/Pictures/Other/prado mona lisa.jpg")
    # source2 = obs.obs_get_source_by_name("test_image2")
    # obs.obs_source_update(source2, settings2)
    # obs.obs_data_release(settings2)
    # obs.obs_source_release(source2)

    # print("check")
    # a = obs.obs_source_get_settings(obs.obs_get_source_by_name("test_image2"))
    # print(a)
    # b = obs.obs_data_get_json(a)
    # print(b)
    # obs.obs_data_set_string(a,"file","C:/Users/Daniel/Pictures/Other/Mona_Lisa.jpg")
    # b = obs.obs_data_get_json(a)
    # print(b)
